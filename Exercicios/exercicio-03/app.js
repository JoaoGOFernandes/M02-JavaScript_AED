...
//console.log(brazilianFoods.concat(['coxinha', null, 'brigadeiro']));   //Primeira Forma

brazilianFoods.push('coxinha', null, 'brigadeiro')
//console.log(brazilianFoods);                                           //Segunda Forma
...
const foodInfo = `Até aqui, o array "brazilianFoods" possui ${brazilianFoods.length} itens: ${brazilianFoods[0]},  
