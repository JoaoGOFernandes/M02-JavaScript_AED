...
const my3FavoriteTVShows = ['Game of Thrones', 'Supernatural', 'How i meet you mother']
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ').replace(', H',' e H')}`
