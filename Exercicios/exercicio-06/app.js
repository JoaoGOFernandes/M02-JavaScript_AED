...
const isAftenoon = currentTime >= 12 && currentTime < 18;
...
for(let i = 0; i < numbers.length; i++){
  const isNumberBetween11and90 = numbers[i] >= 11 && numbers[i] <= 90
...
console.log(`O crazyArray tem ${numbersAmount} booleans, ${booleansAmount} números e ${stringsAmount} strings.`);
...
const evenNumbersString = evenArray.join(', ').replace(', 5',' e 5')
const oddNumbersStrings = oddArray.join(', ').replace(', 3',' e 3')

console.log('Par: ', evenNumbersString);
console.log('Impar: ', oddNumbersStrings);