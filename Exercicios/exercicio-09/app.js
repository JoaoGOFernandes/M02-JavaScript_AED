...
//   }
  ...
  console.log(getStringLength('Bom dia'));
  ...
  */
    ...
    // function isitemIncluded(item, array){
    ...
    console.log(isitemIncluded(4, [1, 2, 3, 4]));
  ...
  */
    ...
    // const concatArrays = function(array1, array2){
    //     return array1.concat(array2)
    // }
  ...
  */
      ...
      const logName = () => console.log("Joao Gabriel");
  ...
  */
      ...
      function getLikesMessage(names = []){
        ...
        switch(names.length){
            ...
            case 1:
                return `${firstNames} curtiu isso`
            case 2:
                return `${firstNames} e ${secondNames} curtiram isso`
            case 3:
                return `${firstNames}, ${secondNames} e ${thirdNames} curtiram isso`    
            default:
                return `${firstNames}, ${secondNames} e mais ${totalNamesMinusTwo} pessoas curtiram isso`
        }

      }

      console.log(getLikesMessage(['Joao', 'Peterson','Dinho', 'Leozin']))