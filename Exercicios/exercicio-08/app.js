...
const divide = function(firstNumber = 0, secondNumber = 1){
    return firstNumber / secondNumber
}
...
function transformToUpperCase(array = []){
    const newArray =[]
    for(value of array){
        const wordInUpperCase = value.toUpperCase()
...
for(value of randomNumbers){
    const isPositiveNumber = NumberIsPositive(value)
    if(isPositiveNumber)
