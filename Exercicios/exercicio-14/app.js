...
const stringCopy = myString.trim()
...
const peopleOrderedByScore = people
    ...
    .sort((people1, people2) => people2.score - people1.score)
...
const animalsCopy = animals.filter(({length}) => length === 3)
