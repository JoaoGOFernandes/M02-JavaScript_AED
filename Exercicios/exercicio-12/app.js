...
const best2019Movies = [
  ...
  let messageBestMovie = `Segundo o site Omelete, os melhores filmes de 2019 são:\n`

  best2019Movies.forEach(movie =>{
    messageBestMovie += `   -${movie.title}, dirigido por ${movie.directedBy} \n`
  })

  console.log(messageBestMovie);
  /*
    02
